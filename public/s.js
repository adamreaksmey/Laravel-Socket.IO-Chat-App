                ...
                return (
                    s != -1 &&
                        ...
                        (p.authority = p.authority
                            ...
                            .replace(/;/g, ":")),
                        (p.ipv6uri = !0)),
                    (p.pathNames = n(p, p.path)),
                    (p.queryKey = r(p, p.query)),
                    p
                );
            };
        },
            ...
            (t.exports = r),
                ...
                (r.prototype.probe = function (t) {
                    ...
                    function c(t) {
                        u &&
                            t.name !== u.name &&
                            (a('"%s" works - aborting "%s"', t.name, u.name),
                            n());
                    }
                    function p() {
        ...
        function (t, e, n) {
            ...
            (e.encodePacket = function (t, e, n, i) {
                ...
                if (
                    ...
                    return o(t, e, i);
                if ("undefined" != typeof k && a instanceof k)
                    return s(t, e, i);
                                    ...
                                    if (
                                        ...
                                        var s =
                                            "string" == typeof o
                                                ? Buffer.byteLength(o)
                                                : o.length;
                                        s < n.perMessageDeflate.threshold &&
                                            (i.compress = !1);
                                    }
                                }
                                try {
